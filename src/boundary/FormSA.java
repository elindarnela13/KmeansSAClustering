 ...
 * @author ASUS
 */
public class FormSA extends javax.swing.JFrame {
    ...
    public FormSA() {
        ...
        RadioButtonParameterSA.setEnabled(false);
 ...
 regenerated by the FormSA Editor.
     */
    ...
    private void initComponents() {
        ...
        RadioButtonParameterSA = new javax.swing.JRadioButton();
        ...
        buttonGroupMetodeCluster.add(RadioButtonParameterSA);
        RadioButtonParameterSA.setText("Parameter SA");
        RadioButtonParameterSA.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RadioButtonParameterSAActionPerformed(evt);
            }
        });
        ...
        PanelMetodeClusterLayout.setHorizontalGroup(
            ...
            .addGroup(PanelMetodeClusterLayout.createSequentialGroup()
                ...
                .addGroup(PanelMetodeClusterLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(RadioButtonParameterSA)
        ...
        PanelMetodeClusterLayout.setVerticalGroup(
            ...
            .addGroup(PanelMetodeClusterLayout.createSequentialGroup()
                ...
                .addComponent(RadioButtonParameterSA, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        TextFieldIterasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TextFieldIterasiActionPerformed(evt);
            }
        });
        ...
        TextFieldTemperaturAkhir.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TextFieldTemperaturAkhirActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addComponent(PanelKmeans, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addGap(25, 25, 25)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(TextFieldDBI, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
...
//				JlhTerm.setText(String.valueOf(bobot.getListDocument().size()));
                    ...
                    RadioButtonParameterSA.setEnabled(true);
...
//                TextFieldMr.setEnabled(true);
                ...
                System.out.println("Waktu komputasi: " + elapsedTime);
                ...
                if (TextFieldIterasi.getText().isEmpty() || TextFieldTemperaturAwal.getText().isEmpty()
                    ...
                    JOptionPane.showMessageDialog(null, "Parameter Algoritma Simulated Annealing tidak boleh kosong",
                            "gagal", JOptionPane.ERROR_MESSAGE);
                } else if ((Double.valueOf(TextFieldTemperaturAwal.getText()) < 50) || (Double.valueOf(TextFieldTemperaturAwal.getText()) > 100)) {
                    JOptionPane.showMessageDialog(null, "Nilai Temperatur Awal harus dalam range 50-100",
                            "gagal", JOptionPane.ERROR_MESSAGE);
                    ...
                    ArrayList<ArrayList> data = bobot.array_to_arraylist(matrix.transpose(data_bobot));
                    int cluster = Integer.valueOf(TextFieldJlhK.getText());
                    int maxIterasi = Integer.valueOf(TextFieldIterasi.getText());
                    double ti = Double.valueOf(TextFieldTemperaturAwal.getText());
                    double t_rendah = Double.valueOf(TextFieldTemperaturAkhir.getText());

                    sa.do_sa(data, cluster, maxIterasi, ti, t_rendah);
                    System.out.println("Enenrgi Akhir= "+ sa.get_energi_akhir());
                    System.out.println("State AkhirSA= "+ sa.getState_akhir());
                    
                    ArrayList<ArrayList> centroid = new ArrayList<ArrayList>();
                    centroid = sa.getState_akhir();
                    km.do_k_means(centroid, data);
...
//                    //----
                    ...
                    System.out.println("Jumlah cluster= " + cluster);
                    System.out.println("iterasi= " + maxIterasi);
                    System.out.println("ti= " + ti);
                    System.out.println("t_rendah= " + t_rendah);

                    sa.do_sa(data_hsl_reduksi, cluster, maxIterasi, ti, t_rendah);
                    
                    System.out.println("Enenrgi Akhir= "+ sa.get_energi_akhir());
                    System.out.println("State Akhir= "+ sa.getState_akhir());
            ...
            } else if (RadioButtonParameterSA.isSelected()) {
                TextFieldIterasi.setEnabled(true);
                TextFieldTemperaturAkhir.setEnabled(true);
                TextFieldTemperaturAwal.setEnabled(true);
...
//                    //----
    ...
    private void TextFieldTemperaturAkhirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TextFieldTemperaturAkhirActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TextFieldTemperaturAkhirActionPerformed

    private void TextFieldIterasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TextFieldIterasiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TextFieldIterasiActionPerformed

    private void RadioButtonParameterSAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RadioButtonParameterSAActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_RadioButtonParameterSAActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormSA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JRadioButton RadioButtonParameterSA;
